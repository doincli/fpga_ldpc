...
#
# Generated by Vivado on Fri Feb 18 20:31:44 +0800 2022
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot H1 xil_defaultlib.H1 xil_defaultlib.glbl -log elaborate.log
}
