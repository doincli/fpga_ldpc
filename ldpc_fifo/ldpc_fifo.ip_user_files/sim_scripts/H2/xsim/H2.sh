...
#
# Generated by Vivado on Fri Feb 18 21:28:06 +0800 2022
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot H2 xil_defaultlib.H2 xil_defaultlib.glbl -log elaborate.log
}
