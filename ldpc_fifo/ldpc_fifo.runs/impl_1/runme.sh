...
HD_PWD='C:/Users/doinc/Desktop/my_ldpc/ldpc_fifo/ldpc_fifo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log encode.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source encode.tcl -notrace
