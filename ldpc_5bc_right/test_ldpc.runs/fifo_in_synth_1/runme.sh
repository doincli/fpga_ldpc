...
HD_PWD='C:/Users/Administrator/Desktop/decode/test_ldpc/test_ldpc.runs/fifo_in_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_in.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_in.tcl
