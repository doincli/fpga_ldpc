...
-- Date        : Wed Mar  9 10:24:57 2022
-- Host        : User-2021FZLJGL running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top ten_bit -prefix
--               ten_bit_ tenbei_sim_netlist.vhdl
-- Design      : tenbei
...
entity ten_bit_tenbei_clk_wiz is
  port (
...
end ten_bit_tenbei_clk_wiz;

architecture STRUCTURE of ten_bit_tenbei_clk_wiz is
...
entity ten_bit is
  ...
  attribute NotValidForBitStream of ten_bit : entity is true;
end ten_bit;

architecture STRUCTURE of ten_bit is
begin
inst: entity work.ten_bit_tenbei_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
