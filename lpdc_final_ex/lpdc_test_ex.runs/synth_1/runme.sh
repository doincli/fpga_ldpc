...
HD_PWD='C:/Users/doinc/Desktop/my_ldpc/lpdc_final_ex/lpdc_test_ex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lpdc_test_exdes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lpdc_test_exdes.tcl
