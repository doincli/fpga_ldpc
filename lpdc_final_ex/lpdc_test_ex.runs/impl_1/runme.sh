...
HD_PWD='C:/Users/doinc/Desktop/my_ldpc/lpdc_final_ex/lpdc_test_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lpdc_test_exdes.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lpdc_test_exdes.tcl -notrace
