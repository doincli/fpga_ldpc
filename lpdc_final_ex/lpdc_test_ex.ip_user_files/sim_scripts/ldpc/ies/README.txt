...
#
# Generated by export_simulation on Mon Feb 21 01:32:58 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './ldpc.sh' script.
...
./ldpc.sh -noclean_files

For more information on the script, please type './ldpc.sh -help'.
